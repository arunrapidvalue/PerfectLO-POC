...
class PerfectLOClient:
    ...
    def create_borrower(self, request_data):
        ...
        create_borrower_api_url = 'https://perfectlo-staging.azurewebsites.net/api/v1/borrowers?SubscriptionID={}'.format(
    ...
    def create_questionnaire(self, request_data, new_borrower_instance):
        ...
        create_questionnaire_api_url = "https://perfectlo-staging.azurewebsites.net/api/v1/questionnaires?SubscriptionID=%s&api_key=%s" % (
        settings.SUBSCRIPTION_ID, settings.SUBSCRIPTION_ID)
    ...
    def submit_question_answers(self, api_post_data={}):
        ...
        nextQuestionId = ''
        api_question_post_url = "https://perfectlo-staging.azurewebsites.net/api/v1/questions?SubscriptionID=%s&api_key=%s" % (
        settings.SUBSCRIPTION_ID, settings.SUBSCRIPTION_ID)
    ...
    def submit_questionnaire(self, borrowerId, questionnaireId, loanOfficerId):
        ...
        api_submit_questionnaire_url = "https://perfectlo-staging.azurewebsites.net/api/v1/submit?SubscriptionID=%s&api_key=%s" % (
        settings.SUBSCRIPTION_ID, settings.SUBSCRIPTION_ID)
